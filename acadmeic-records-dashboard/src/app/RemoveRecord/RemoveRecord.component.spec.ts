...
import { RemoveRecordComponent } from './RemoveRecord.component';
...
describe('RemoveRecordComponent', () => {
  ...
  let mockRemoveRecordService;
  let mockDataService

  beforeEach(async(() => {

    mockRemoveRecordService = sinon.createStubInstance(RemoveRecordService);
    mockRemoveRecordService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RemoveRecordService, useValue: mockRemoveRecordService },
