...
export class IssuerComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      ...
      'issuerName': this.issuerName.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceIssuer.updateParticipant(form.get('crNumber').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.crNumber) {
        formObject.crNumber = result.crNumber;
      } else {
        formObject.crNumber = null;
      }

      if (result.issuerName) {
        formObject.issuerName = result.issuerName;
      } else {
        formObject.issuerName = null;
      }
