...
describe('EditRecordComponent', () => {
  ...
  let mockEditRecordService;
  let mockDataService

  beforeEach(async(() => {

    mockEditRecordService = sinon.createStubInstance(EditRecordService);
    mockEditRecordService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: EditRecordService, useValue: mockEditRecordService },
