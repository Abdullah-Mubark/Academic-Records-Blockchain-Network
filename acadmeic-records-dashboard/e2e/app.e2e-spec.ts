...
describe('Starting tests for acadmeic-records-dashboard', function() {
  ...
  it('navbar-brand should be acadmeic-records-dashboard',() => {
    ...
    it('AcademicRecord component should be loadable',() => {
      page.navigateTo('/AcademicRecord');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('AcademicRecord');
      });
    });

    it('AcademicRecord table should have 10 columns',() => {
      page.navigateTo('/AcademicRecord');
    ...
    it('Citizen table should have 8 columns',() => {
      page.navigateTo('/Citizen');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Issuer table should have 4 columns',() => {
      page.navigateTo('/Issuer');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('AddRecord component should be loadable',() => {
      page.navigateTo('/AddRecord');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('AddRecord');
      });
    });
  
    it('RemoveRecord component should be loadable',() => {
      page.navigateTo('/RemoveRecord');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('RemoveRecord');
      });
    });
  
    it('EditRecord component should be loadable',() => {
      page.navigateTo('/EditRecord');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
