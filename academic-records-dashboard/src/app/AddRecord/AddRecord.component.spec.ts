...
describe('AddRecordComponent', () => {
  ...
  let mockAddRecordService;
  let mockDataService

  beforeEach(async(() => {

    mockAddRecordService = sinon.createStubInstance(AddRecordService);
    mockAddRecordService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AddRecordService, useValue: mockAddRecordService },
